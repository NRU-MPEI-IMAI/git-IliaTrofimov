...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \end{center}
        Строить граф для данного ДКА нецелесообразно, т.к. он будет слишком большим.
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        Для построения этого автомата используем упрощённую версию автомата \(L_2\), которая была получена в пункте 2 этого задания.         Перепишем названия узлов графов \(L_2\) и \(\neg L_3\):
        \begin{center}
    ...
    \begin{enumerate}
        ...
        \begin{center}
            ...
            \end{tabular}
        \end{center}
        Получили следующий детерминированный автомат, он минимальный:
        \begin{center}
